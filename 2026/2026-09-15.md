...
type: daily-log
dc_type: Text
identifier: dailyvault:2026/2026-09-15
...
- [ ] 🔽 Python 实践：完成`learn-python`对应的章节练习题
- [ ] 🔽 Python 实践：阅读 GitHub Python 项目源码
- [ ] 研究下 ursb.me 网站的各个模块数据来源、数据同步的原理
- [ ] 🔺 MRZZZ` 工程分模块验证与方案优化
	- 心情、活动、运动记录这三个模块已经做完
...
- 随着年龄增长，护城河应该是把自己的经验总结成 skill 作为自己的一套工作流 这样的话 不管在什么时候 它都能帮助你提高效率 你还可以学习更多的东西去丰富自己再沉淀出更多有价值的东西
