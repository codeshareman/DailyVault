...
type: clipping
dc_type: Text
identifier: https://webidl.spec.whatwg.org/
source: https://webidl.spec.whatwg.org/
canonical_url: https://webidl.spec.whatwg.org/
description: Living Standard — Last Updated 31 August 2026
category: standards
subject:
- standards
- web-standards
...
> [!abstract] 摘要
> 该页面未公开返回元描述；书签原始标题为“Web IDL Standard”。

[阅读原文](https://webidl.spec.whatwg.org/)
